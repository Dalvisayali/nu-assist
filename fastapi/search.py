...
def query_message(
    ...
    introduction = 'Use the below articles on the Find at Northeastern to answer the subsequent question.'
    question = f"\n\nQuestion: {query}"
...
def ask(
    ...
    if print_message:
        print(message)
    messages = [
        {"role": "system", "content": "You are a helpful assistant who answer questions about Northeastern University."},
